...
export default Service.extend({
  ...
  init() {
    ...
    debugger
    let balancerServices = store.all('service').filterBy('kind','LoadBalancer');
    const out = (balancerServices||[]).slice();
    out.addObjects(store.all('ingress')||[]);
    set(this, '_allDnsRecords', out);
  },
