...
export default Component.extend({
  ...
  grouped: computed('allIngresses.list.[]', 'selectedNamespace', function () {
    let list = get(this, 'allIngresses.list');
    ...
    let out = get(this, 'allIngresses').group(list);
    let selected = get(this, 'allIngresses').byId(get(this, 'selected'));
  ...
  selectedChanged: observer('selected', function () {
    ...
    if (id) {
      dnsRecord = get(this, 'allIngresses').byId(id);
      if (dnsRecord) {
